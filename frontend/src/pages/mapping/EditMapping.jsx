  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const response = await axiosInstance.get(`${EXCEL_API}/api/fetchMappingColumnRecord/${id}`);
    ...
    <div style={{ marginLeft: "20px", marginTop: "50px" }}>
      ...
      <form onSubmit={handleSubmit} style={{}}>
        ...
        {/* {submissionStatus === "success" && (
          <p style={{ color: "green" }}>Mapped data saved successfully!</p>
        )}
        {submissionStatus === "error" && (
          <p style={{ color: "red" }}>Failed to save mapped data.</p>
        )} */}
         <button
        type="submit"
