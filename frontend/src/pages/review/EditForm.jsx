...
const EditUserDetails = () => {
  ...
  //fetch user data with  id from fetchingestion Details API
  // useEffect(() => {
  //   const fetchUserData = async () => {
  //     try {
  //       const response = await axios.get(
  //         `/api/fetchIngestionDetailsById/${id}/details?dataId=${dataId}`
  //       );
  //       const data = response.data.data;

  //       const localStorageChanges = localStorage.getItem(
  //         `userChanges_${id}_${dataId}`
  //       );
  //       let mergedData = data;
  //       if (localStorageChanges) {
  //         const changes = JSON.parse(localStorageChanges);
  //         mergedData = { ...data, ...changes };
  //         setChanges(changes);
  //       }
    ...
    const fetchUserData = async () => {
        try {
            ...
            if (updatedUserData) {
                ...
                const updatedUserObject = updatedUserData.find(obj => obj.id === fetchedData.id);
  ...
  const handleInputChange = (e) => {
    ...
    //   const updatedChanges = { ...prevChanges, [name]: value };
  ...
  const handleSubmit = async () => {
    try {
      ...
      // await axios.put(
      //   `/api/updateIngestionDetailsById/${id}/details?dataId=${dataId}`,
      //   changes
      // );
