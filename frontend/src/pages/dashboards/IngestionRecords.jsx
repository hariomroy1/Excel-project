...
//     try {
//       const response = await fetch(`${EXCEL_API}/api/fetchIngestionRecords`);
//       if (!response.ok) {
//         throw new Error("Failed to fetch ingestion records");
//       }
...
//     try {
//       const response = await fetch(`${EXCEL_API}/api/deleteIngestionRecord/${id}`, {
//         method: "DELETE",
//       });
//       if (!response.ok) {
//         throw new Error("Failed to delete ingestion record");
//       }
...
// src/pages/dashboards/IngestionRecords.js
import React, { useState, useEffect } from "react";
import { Link } from "react-router-dom";
import DeleteForeverIcon from "@mui/icons-material/DeleteForever";
import PlayArrowIcon from "@mui/icons-material/PlayArrow";
